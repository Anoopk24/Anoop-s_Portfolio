export default function Footer() {
  return (
    <footer className="border-t border-slate-200 p-8 text-center text-slate-600 bg-white/50 backdrop-blur-sm relative z-10">
      <p>&copy; {new Date().getFullYear()} Anoop Kaur. All rights reserved.</p>
      <p className="text-sm mt-1 opacity-60">anoopkaur.org</p>
