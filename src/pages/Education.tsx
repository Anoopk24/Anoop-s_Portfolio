  ...
  return (
    <div id="education" className="bg-white text-slate-900 min-h-screen py-12 scroll-mt-24">
      <main className="container-width section-padding">
        <h1 className="heading-lg mb-16">Education</h1>
        
        <section className="mb-24">
          <div className="card-hover !p-12">
            <h2 className="text-3xl font-display font-bold text-primary mb-4">Diploma in Software Development</h2>
        ...
        <section>
          <h2 className="heading-lg mb-12">Professional Certifications</h2>
